...
class TestCity(unittest.TestCase):
    ...
    def test_2(self):
        ...
        res = self.NERInstance.predictAdress(testing_address)
        res = res[0]
        self.assertEqual((res.City.name, res.City.city_type), ('липецк', 'город'))
    ...
    def test_3(self):
        ...
        res = self.NERInstance.predictAdress(testing_address)
        res = res[0]
        self.assertEqual((res.City.name, res.City.city_type), ('сургут', None))
    ...
    def test_9(self):
        ...
        res = self.NERInstance.predictAdress(testing_address)
        res = res[0]
        self.assertEqual((res.City.name, res.City.city_type), ('нальчик', 'город'))
    ...
    def test_13(self):
        ...
        res = self.NERInstance.predictAdress(testing_address)
        res = res[0]
        self.assertEqual((res.City.name, res.City.city_type), ('москва', None))
