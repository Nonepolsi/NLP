...
class TestPersons(unittest.TestCase):
    ...
    def test_1(self):
        testing_person = 'Иванов Петр Васильевич'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
        self.assertEqual(res.first, 'пётр')
        self.assertEqual(res.middle, 'васильевич')
        self.assertEqual(res.last, 'иванов')

    def test_2(self):
        testing_person = 'шипицын дмитрий вячеславович'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
    ...
    def test_3(self):
        testing_person = 'елена владимировна'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
    ...
    def test_4(self):
        testing_person = 'басалаева юлия михайловна'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
    ...
    def test_5(self):
        testing_person = 'ну я как раз по фамилии есть смотри мам'
        res = self.NERInstance.predictPerson(testing_person)
        self.assertEqual(res, [])


    def test_6(self):
        testing_person = 'глушенков власти на android'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
    ...
    def test_7(self):
        testing_person = 'фамилию сказать что за фамилия терентьева людмила'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
    ...
    def test_10(self):
        testing_person = 'р1 артем витальевич'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
        self.assertEqual(res.first, 'артём')
        self.assertEqual(res.middle, 'витальевич')
        self.assertEqual(res.last, None)
        
    def test_11(self):
        testing_person = 'фитнес веретельников олег викторович'
        res = self.NERInstance.predictPerson(testing_person)
        res = res[0]
